...
{
	uint8_t x_variance = _sub_visual_odom.get().POSITION_COVARIANCE_X_VARIANCE;
	uint8_t y_variance = _sub_visual_odom.get().POSITION_COVARIANCE_Y_VARIANCE;
	uint8_t z_variance = _sub_visual_odom.get().POSITION_COVARIANCE_Z_VARIANCE;
